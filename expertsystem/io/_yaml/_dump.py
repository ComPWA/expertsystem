...
def _to_quantum_number_dict(particle: Particle) -> dict:
    ...
    optional_qn: List[
        ...
        ("Strangeness", particle.strange, int),
        ("Charmness", particle.charm, int),
        ("Bottomness", particle.bottom, int),
        ("Topness", particle.top, int),
        ("BaryonNumber", particle.baryon, int),
        ("ElectronLN", particle.ln_e, int),
        ("MuonLN", particle.ln_mu, int),
